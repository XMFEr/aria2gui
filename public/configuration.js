...
.constant('$titlePattern', '↓ {download_speed} — ↑ {upload_speed} — {name}' )
.constant('$pageSize', 12)         // number of downloads shown before pagination kicks in
...
.constant('$enable', {
  ...
  sidebar: {            // configuration related to the sidebar next to the list of downloads
    ...
    filters: false,      // set to false to hide the  Download Filters
